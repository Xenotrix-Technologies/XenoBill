...
class PrintingFormatsModal extends StatefulWidget {
  const PrintingFormatsModal({super.key});
  ...
  static void show(BuildContext context) {
    showModalBottomSheet(
      ...
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (ctx) => const PrintingFormatsModal(),
    );
  }
...
class _PrintingFormatsModalState extends State<PrintingFormatsModal> {
  ...
  void initState() {
    super.initState();
    selectedFormat = AppDatabase.instance.invoiceDisplaySettings.paperSize;
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              ...formats.map((f) => RadioListTile<String>(
                    value: f['name']!,
                    groupValue: selectedFormat,
                    title: Text(f['name']!, style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.darkNavy)),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Primary print format set to $selectedFormat')),
                    );
                    Navigator.pop(context);
                  },
                  style: ElevatedButton.styleFrom(
